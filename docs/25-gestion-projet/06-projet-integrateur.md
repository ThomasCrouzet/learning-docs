...
**Définition** : Le daily standup (ou mêlée quotidienne / Daily Scrum) est une réunion de 15 minutes maximum, chaque jour à la même heure. Son but est d'inspecter la progression vers l'objectif du sprint et d'adapter le plan du jour. Un format courant (non imposé par le Scrum Guide 2020) : qu'ai-je fait hier ? Que vais-je faire aujourd'hui ? Ai-je un blocage ?
