...
```bash
gcc -Wall -Wextra -Werror pointeurs.c -o pointeurs
./pointeurs
```
...
```bash
gcc -Wall -Wextra -Werror passage_adresse.c -o passage_adresse
./passage_adresse
```
...
```bash
gcc -Wall -Wextra -Werror arithmetique_ptr.c -o arithmetique_ptr
./arithmetique_ptr
```
...
```bash
gcc -Wall -Wextra -Werror pointeur_null.c -o pointeur_null
./pointeur_null
```
...
```bash
gcc -Wall -Wextra -Werror multi_retour.c -o multi_retour
./multi_retour
```
