...
```bash
gcc -std=c17 -Wall -Wextra -Werror fonctions.c -o fonctions
./fonctions
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror prototypes.c -o prototypes
./prototypes
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror passage_valeur.c -o passage_valeur
./passage_valeur
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror portee.c -o portee
./portee
```
