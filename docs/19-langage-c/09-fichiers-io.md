...
```bash
gcc -Wall -Wextra -Werror ecrire_fichier.c -o ecrire_fichier
./ecrire_fichier
```
...
```bash
gcc -Wall -Wextra -Werror lire_fichier.c -o lire_fichier
./lire_fichier
```
...
```bash
gcc -Wall -Wextra -Werror binaire.c -o binaire
./binaire
```
...
```bash
gcc -Wall -Wextra -Werror arguments.c -o arguments
...
```bash
gcc -Wall -Wextra -Werror erreurs.c -o erreurs
