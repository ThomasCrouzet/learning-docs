...
```bash
gcc -Wall -Wextra -Werror structures.c -o structures
./structures
```
...
```bash
gcc -Wall -Wextra -Werror struct_pointeur.c -o struct_pointeur
./struct_pointeur
```
...
```bash
gcc -Wall -Wextra -Werror enums.c -o enums
./enums
```
...
```bash
gcc -Wall -Wextra -Werror unions.c -o unions
./unions
```
...
```bash
gcc -Wall -Wextra -Werror alignement.c -o alignement
./alignement
```
