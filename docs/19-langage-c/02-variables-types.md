...
total_fiches: 10
cursus: "Langage C"
id: "infrastructure.c.variables-types"
...
```bash
gcc -std=c17 -Wall -Wextra -Werror types.c -o types
./types
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror tailles.c -o tailles
./tailles
```
...
```bash
gcc -std=c17 -Wall -Wextra signed_unsigned.c -o signed_unsigned
./signed_unsigned
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror constantes.c -o constantes
./constantes
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror saisie.c -o saisie
./saisie
```
