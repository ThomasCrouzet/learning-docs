...
gcc -Wall -Wextra -Werror -c tache.c -o tache.o
gcc -Wall -Wextra -Werror -c stockage.c -o stockage.o
...
gcc -Wall -Wextra -Werror -fsanitize=address -g main.c tache.c stockage.c -o todo
