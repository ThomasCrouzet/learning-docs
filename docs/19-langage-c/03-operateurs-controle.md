...
total_fiches: 10
cursus: "Langage C"
id: "infrastructure.c.operateurs-controle"
...
```bash
gcc -std=c17 -Wall -Wextra -Werror operateurs.c -o operateurs
./operateurs
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror logique.c -o logique
./logique
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror conditions.c -o conditions
./conditions
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror switch_exemple.c -o switch_exemple
./switch_exemple
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror boucles.c -o boucles
./boucles
```
...
```bash
gcc -std=c17 -Wall -Wextra -Werror while_exemple.c -o while_exemple
echo "5
3
0" | ./while_exemple
```
