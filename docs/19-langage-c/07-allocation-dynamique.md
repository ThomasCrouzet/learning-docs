...
```bash
gcc -Wall -Wextra -Werror malloc_base.c -o malloc_base
./malloc_base
```
...
```bash
gcc -Wall -Wextra -Werror calloc_exemple.c -o calloc_exemple
./calloc_exemple
```
...
```bash
gcc -Wall -Wextra -Werror realloc_exemple.c -o realloc_exemple
./realloc_exemple
```
...
```bash
gcc -Wall -Wextra -Werror chaine_dynamique.c -o chaine_dynamique
