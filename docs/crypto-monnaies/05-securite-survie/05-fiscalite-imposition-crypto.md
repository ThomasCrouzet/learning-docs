...
| Échange de crypto contre crypto | Non | L'échange BTC contre ETH n'est PAS un fait générateur d'imposition |
...
**Point essentiel** : L'échange crypto-crypto n'est PAS imposable. Si tu échanges du Bitcoin contre de l'Ethereum, aucune plus-value n'est à déclarer à ce moment-là. L'imposition intervient uniquement quand tu sors vers du fiat.
...
| Échange crypto-crypto | Pas imposable |
...
- [ ] Je sais que la conversion crypto vers fiat déclenche l'imposition, mais pas l'échange crypto-crypto
