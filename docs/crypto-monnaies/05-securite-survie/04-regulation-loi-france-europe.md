...
!!! warning "Pas un conseil juridique"
    Fiche **pédagogique** uniquement. Elle ne constitue pas un avis juridique et ne remplace pas un avocat, un conseiller réglementaire ni les textes officiels (loi PACTE, règlement MiCA, listes AMF). Le cadre évolue (transition PSAN vers agrément CASP/MiCA) : vérifie `amf-france.org` et EUR-Lex avant toute décision.
...
**Définition** : MiCA (Markets in Crypto-Assets Régulation) est le premier cadre réglementaire complet pour les crypto-actifs en Europe. Adopté en 2023, l'essentiel des dispositions applicables aux prestataires (CASP) s'applique depuis le 30 décembre 2024 (certaines règles, notamment sur les stablecoins, ont eu des dates d'application antérieures en 2024). Vérifie les dates exactes et le statut de chaque acteur sur EUR-Lex et `amf-france.org`.
...
| Une plateforme enregistrée en France devait se reenregistrer dans chaque pays | Un agrément dans un pays de l'UE peut ouvrir un "passeport" pour opérer dans l'UE (sous conditions) |
