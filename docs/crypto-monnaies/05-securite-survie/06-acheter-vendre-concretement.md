...
Cette fiche décrit un geste technique. Elle ne constitue **pas un conseil d'investissement** : aucun montant, aucun token et aucun moment d'achat ou de vente n'y sont recommandés.
...
- Vendre une crypto-monnaie contre une autre (par exemple Bitcoin contre Ethereum) n'est PAS une sortie vers des euros : ce n'est donc pas imposable à ce moment-là (voir fiche 05)
...
- [ ] Je comprends que c'est la revente vers des euros qui déclenche l'imposition (et pas l'échange crypto-crypto)
