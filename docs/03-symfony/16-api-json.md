...
curl -X GET http://localhost:8000/api/articles/999
```
...
```bash
curl -X DELETE http://localhost:8000/api/articles/1 -v
```
...
| `curl -X GET http://localhost:8000/api/articles` | Tester un endpoint GET |
