...
✅ **Solution** : 5 participants suffisent pour détecter 85% des problèmes d'utilisabilité (étude de Jakob Nielsen). En dessous de 5, les résultats ne sont pas fiables. Pour l'A/B testing, il faut beaucoup plus de participants (1000+ par version).
...
**Enonce** : Mene un cycle complet de test et d'itération sur un site web ou une application existante.
