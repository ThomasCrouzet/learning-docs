...
> **En bref** : Apprendre à créer des wireframes basse et haute fidélité, utiliser Figma et Excalidraw, realiser un prototype interactif et appliquer l'approche mobile-first. Lecture estimée : 75 min.
...
**Enonce** : Créé les wireframes complets pour une application de gestion de tâches (to-do list) en suivant l'approche mobile-first.
