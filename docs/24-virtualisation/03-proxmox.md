...
2. Crée une clé USB bootable avec `dd` (Linux), Rufus (Windows) ou balenaEtcher (multi-plateforme). Adapte le nom de fichier a l'ISO telechargee, par exemple : `sudo dd if=proxmox-ve_9.2-1.iso of=/dev/sdX bs=4M status=progress`
