...
> **En bref** : Ce wiki est une documentation pédagogique francophone structurée pour l'apprentissage en autonomie et pensée pour mieux convenir à un public neurodivergent. Lecture estimée : 8 min.

## Objectif

Fournir des fiches de cours **explicites**, **ordonnées** et **vérifiables**, utilisables **hors ligne** après téléchargement ou hébergement local, avec une structure compatible avec des besoins fréquents chez les apprenants neurodivergents.

Le public visé est large : débutants, personnes en reconversion et personnes neurodivergentes qui ont besoin d'une progression prévisible. La structure privilégie l'**explicite**, la **prévisibilité**, les étapes courtes et la **réduction de la charge cognitive**. Ce choix éditorial **ne constitue pas** une validation clinique ni une garantie d'adaptation à chaque personne neurodivergente. Il ne remplace pas un accompagnement pédagogique adapté lorsque celui-ci est nécessaire.
...
| Versions de référence | versions documentées dans les fiches et les métadonnées du projet : PHP 8.3, Symfony 7.4 LTS, PostgreSQL 16, Node.js 22 LTS, etc. |
