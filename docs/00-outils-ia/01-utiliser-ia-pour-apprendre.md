...
**Pourquoi c'est dangereux** : même quand une IA dit "je ne suis pas sûre" ou refuse de répondre, elle peut encore se tromper ailleurs avec assurance. Tu ne peux pas te fier au ton de la réponse : une formulation confiante n'indique pas que le contenu est correct.
...
## Comparatif des IA disponibles (2026)

Ce tableau présente des IA conversationnelles courantes. Les offres gratuites, limites et politiques de confidentialité changent souvent : vérifie les conditions actuelles de chaque éditeur avant d'y coller du code sensible.

**Prérequis d'accès** : ces outils nécessitent en général une connexion internet. Si tu travailles hors ligne, utilise d'abord la documentation locale de ce wiki et les manuels installés sur ta machine.

| IA           | Éditeur             | Accès gratuit   | Forces                                                                 | Faiblesses                                                               | Confidentialité (à vérifier)                   |
| ------------ | ------------------- | --------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------ | ---------------------------------------------- |
| **ChatGPT**  | OpenAI (USA)        | Oui, limité     | Polyvalent, très populaire, beaucoup de tutoriels disponibles          | Réponses parfois verbeuses, hallucinations possibles                     | Selon le plan : les données peuvent servir à l'entraînement |
| **Claude**   | Anthropic (USA)     | Oui, limité     | Bon pour le code et les réponses structurées                           | Connaissances avec un décalage temporel                                  | Politique souvent stricte sur l'usage des chats (lire les CGU) |
| **Gemini**   | Google (USA)        | Oui             | Intégré à Google, accès fréquent à des infos récentes                  | Fortement lié à l'écosystème Google                                      | Données traitées par Google                    |
| **Mistral**  | Mistral AI (France) | Oui             | Entreprise européenne, options d'hébergement en Europe                 | Écosystème d'aide en ligne plus petit que ChatGPT                        | Hébergement et options RGPD à vérifier         |
| **DeepSeek** | DeepSeek (Chine)    | Oui             | Gratuit, performant sur certains benchmarks                            | Confidentialité limitée selon le plan ; données potentiellement hors UE  | À éviter pour code ou données personnelles     |
| **Grok**     | xAI (USA)           | Via x.com / grok.com | Accès à des infos récentes via X, utile pour des questions d'actualité | Qualité variable selon le sujet ; vérifier comme pour toute IA           | Données traitées par xAI ; lire les CGU        |

**Recommandations** :

- **Pour du code sensible ou des données personnelles** : préfère un outil dont tu as lu la politique de confidentialité (souvent Claude ou Mistral en Europe), ou travaille hors ligne sans coller de secrets.
- **Pour un usage quotidien général** : ChatGPT, Claude, Gemini, Mistral ou Grok conviennent si tu **vérifies** toujours les réponses.
- **À traiter avec prudence** : DeepSeek (ou tout service dont tu ne maîtrises pas le traitement des données) pour tout contenu confidentiel.
...
| Code obsolète                        | Code actuel (vérifié pour ta version) |
| ------------------------------------ | ------------------------------------- |
