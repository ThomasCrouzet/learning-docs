...
| Réponses incorrectes   | La doc est écrite par les créateurs, donc toujours correcte |
...
**Analogie concrète** : La documentation officielle est comme le mode d'emploi fourni avec un appareil électroménager. Ce n'est peut-être pas le plus amusant à lire, mais c'est toujours correct et à jour pour ton modèle exact. Un tutoriel YouTube sur "comment utiliser un four", lui, peut être pour un autre modèle.
...
4. **Blogs techniques récents** (2023-2025) - Vérifier la date
...
- TOUJOURS vérifier la date de la réponse (préférer 2023-2025)
