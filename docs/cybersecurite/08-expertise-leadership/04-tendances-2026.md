...
2. **Personnalisation du phishing** : les LLM génèrent des emails de phishing personnalisés, contextuels et sans fautes, rendant la détection quasi impossible
...
1. **Volume d'alertes ingérable** : un SOC reçoit des milliers d'alertes par jour, dont 95% sont des faux positifs
...
4. **Pénurie de personnel** : il manque 3.5 millions de professionnels cyber dans le monde (ISC2, 2025)

**Comment l'IA défensive résout ces problèmes** :

| Problème | Solution apportée par l'IA défensive |
| -------- | ------------------------------------- |
| Volume d'alertes | Corrélation et priorisation automatique, réduction des faux positifs de 95% à 20% |
