...
tags:
  ...
  - Avancé
  - Concept
description: "Guide de préparation aux certifications offensives : OSCP, OSWE, OSEP, PNPT, CRTP"
...
# 05 - Certifications Offensives - Guide et Préparation

> **En bref** : À la fin de cette fiche, tu sauras identifier la certification offensive adaptée à ton niveau et tes objectifs, structurer un plan de préparation de 3 à 6 mois, connaître le format et les exigences de chaque examen (OSCP, OSWE, OSEP, PNPT, CRTP) et maximiser tes chances de réussite. Lecture estimée : 45 min.
...
À la fin de cette fiche, tu sauras identifier la certification offensive adaptée à ton niveau et tes objectifs, structurer un plan de préparation de 3 à 6 mois, connaître le format et les exigences de chaque examen (OSCP, OSWE, OSEP, PNPT, CRTP) et maximiser tes chances de réussite.

---

## Concepts

### Qu'est-ce qu'une certification offensive ?

**Définition** : Une certification offensive est une accréditation professionnelle qui valide les compétences pratiques en test d'intrusion et en sécurité offensive, via un examen pratique où le candidat doit compromettre des systèmes réels dans un temps limité.
...
- Une certification n'est pas permanente pour certaines (CompTIA PenTest+ nécessite un renouvellement tous les 3 ans). D'autres, comme l'OSCP, n'expirent pas.
...
**Définition** : L'OSCP+ (Offensive Security Certified Professional) est la certification de pentest la plus reconnue dans l'industrie, délivrée par OffSec (anciennement Offensive Security). L'examen pratique de 23h45 exige la compromission de machines dans un environnement contrôlé.
