...
> **Place de jQuery en 2026** : enseigné ici pour **lire et maintenir** du code existant (Symfony hérité, plugins), pas comme choix par défaut d'un greenfield. Pour un nouveau front : JavaScript natif, Stimulus (fiche 06) ou AssetMapper (fiche 07). jQuery 4.0.0 (janvier 2026) casse des API dépréciées ; cette fiche reste sur **3.7.x** (correctifs sécurité). Ne démarre un nouveau projet avec jQuery que si une dépendance l'impose.
