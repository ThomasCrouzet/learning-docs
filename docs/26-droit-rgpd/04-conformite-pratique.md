...
| Data Privacy Framework (DPF) | Cadre spécifique UE-États-Unis adopté en 2023 (décision d'adéquation Commission) | Entreprises américaines certifiées DPF (liste officielle à vérifier) |
...
**Point de vigilance** : L'utilisation de services américains (Google Cloud, AWS, Azure) implique souvent un transfert hors UE. S'assurer que le prestataire est certifié DPF **ou** que des CCT (et mesures complémentaires si besoin) sont en place.

**Cadre évolutif (pas de certitude figée)** : les décisions d'adéquation et le DPF peuvent être contestés ou invalidés (précédents Schrems I / Schrems II sur Safe Harbor et Privacy Shield). À la date de rédaction (2026), le DPF est le cadre UE-US en vigueur, mais ce n'est **pas** une garantie permanente : suivre la CNIL, la Commission européenne et la jurisprudence de la CJUE.
