...
**Exemple concret** : Les données d'un candidat non retenu à un emploi doivent être supprimées après un délai raisonnable (la CNIL recommande 2 ans maximum). Les conserver indéfiniment "au cas où" est interdit.
