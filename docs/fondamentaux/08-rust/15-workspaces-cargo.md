...
total_fiches: 16
cursus: "Rust"
id: "fundamentals.rust.workspaces-cargo"
...
[workspace]
# resolver "3" est le défaut avec edition 2024 (resolver "2" reste correct pour edition 2021)
resolver = "3"
...
- `resolver = "3"` : résolveur de dépendances aligné sur l'édition 2024 (prend en compte `rust-version`). Avec l'édition 2021, `resolver = "3"` reste valide.
