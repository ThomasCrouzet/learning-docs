...
**Tailles de context window courantes** (ordres de grandeur, à vérifier sur la doc éditeur - les plafonds évoluent vite) :

| Modèle (exemples) | Context window (indicatif) | Équivalent approximatif |
| ----------------- | -------------------------- | ----------------------- |
| GPT-4o | 128K tokens | ~96 000 mots |
| Claude Sonnet 4.x / Opus 4.x | 200K à 1M tokens (selon offre) | ~150 000 à ~750 000 mots |
| Gemini 1.5 / 2.x Pro | jusqu'à 1M+ tokens | ~750 000 mots et plus |
| Llama 3.1 / 3.x | 128K tokens (souvent) | ~96 000 mots |

Les anciens plafonds (ex. GPT-3.5 à 16K, Claude 3.5 à 200K) restent utiles pour comprendre l'historique, mais ne sont plus la référence pour les API actuelles.
