...
tags:
  ...
  - Intermédiaire
  - Pratique
description: "BC03 - 04 - Le Déploiement Continu (CI/CD)"
...
# BC03 - 04 - Le Déploiement Continu (CI/CD)
...
- Fiche **[BC03 - 03 - L'Infrastructure as Code](03-infrastructure-as-code.md)**
...
```mermaid
flowchart LR
    commit[Commit] --> ci[CI<br>Tests + Lint]
    ci -->|Succès| build[Build<br>Image Docker]
    build --> staging[Déploiement<br>Staging]
    staging -->|Validation| prod[Déploiement<br>Production]
    ci -->|Échec| fix[Corriger]
```
...
← Fiche précédente : **[BC03 - 03 - L'Infrastructure as Code (IaC)](03-infrastructure-as-code.md)**

→ Fiche suivante : **[BC03 - 05 - Les Bases de Kubernetes](05-kubernetes-bases.md)**
