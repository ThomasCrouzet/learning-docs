...
tags:
  ...
  - Intermédiaire
  - Pratique
description: "Apprendre à écrire des tests unitaires JavaScript avec Jest 29 : describe, expect, mocks et tests asynchrones."
...
> **En bref** : Cette fiche te guide dans l'installation et l'utilisation de Jest 29 pour écrire des tests unitaires JavaScript avec describe/it, expect, mocks et tests asynchrones. Lecture estimée : 90 min.
