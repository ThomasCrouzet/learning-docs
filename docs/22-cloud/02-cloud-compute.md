...
| Serveur de jeu (WebSocket) | **VM** (EC2) | Les connexions WebSocket sont persistantes et longues. Le serverless n'est pas adapte car Lambda a une durée d'exécution limitée a 15 minutes. Une VM permet de maintenir des connexions permanentes et d'avoir un controle total sur le serveur. |
