...
### Étape 1 : Creer un compte AWS Free Tier

AWS propose un Free Tier (offre gratuite) pendant 12 mois pour découvrir les services.
...
4. Ajoute les informations de facturation (une carte bancaire est requise, mais tu ne seras pas debite tant que tu restes dans les limites du Free Tier)
5. Verifie ton identité par telephone
6. Selectionne le plan **Basic Support** (gratuit)
...
- [ ] J'ai un compte AWS Free Tier fonctionnel
